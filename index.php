	...
	<body class="body">
		<div class="container">
		    <form action="" class="parent">
		        <input type="text">
		        <input type="button" value="搜索股票">
		    </form>
		</div>
		
		<div id="SH_Index01" style="width: 100%;height: 600px;"></div>
		<div id="SH_Index02" style="width: 100%;height: 600px;"></div>
		<div id="SH_Index03" style="width: 100%;height: 600px;"></div>
		
		6
		<script type="text/javascript">
			// 基于准备好的dom，初始化echarts实例
            var myChart = echarts.init(document.getElementById('SH_Index01'));
		...
		<script type="text/javascript">
			// 基于准备好的dom，初始化echarts实例
            var myChart = echarts.init(document.getElementById('SH_Index02'));
			...
			function calculateTOP(dayCount)
			{
				var result = [];
			    for (var i = 0, len = data0.values.length; i < len; i++) {
			        if (i < dayCount) {
			        ...
			        for (var j = 0; j < dayCount; j++) 
			        {
			            temp += (data0.values[i - j][1]-mean)*(data0.values[i - j][1]-mean);
			        }
			        std=Math.sqrt(temp/dayCount);
			        var top=0;
			        top=mean+2.2*std;
			        result.push(top);
			    }
			...
			function calculateBottom(dayCount)
			{
				var result = [];
			    for (var i = 0, len = data0.values.length; i < len; i++) {
			        if (i < dayCount) {
		...
		<script type="text/javascript">
			// 基于准备好的dom，初始化echarts实例
            var myChart = echarts.init(document.getElementById('SH_Index03'));
